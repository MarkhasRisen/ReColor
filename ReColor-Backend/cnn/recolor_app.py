...
class ReColorApp:
    ...
    def _log_system_info(self) -> None:
        """Log system and CPU information."""
        self.logger.info("=== System Information ===")
        
        self.logger.info(f"✅ CPU: {self.cpu_info['cpu_cores']} cores available")
        self.logger.info(f"TensorFlow Version: {self.cpu_info['tf_version']}")
        self.logger.info(f"Device: {self.cpu_info['device']}")
        self.logger.info("Using CPU optimization for maximum performance")
...
if __name__ == "__main__":
    ...
    try:
        ...
        if success:
            ...
            print(f"CPU Cores: {status['cpu_info']['cpu_cores']}")
